...
const FeedbackPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post("http://localhost:5000/feedback/add",formData).then((res)=>console.log(res)).catch((err)=>console.log(err))
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
          {submitted ? (
            <div className="text-center text-green-500">
              ...
              <Link to="/home" className="text-red-500 hover:text-red-700">Back to Home</Link>
            </div>
          ) : (
